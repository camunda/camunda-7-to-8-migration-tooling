...
public class HistoryDateConversionTest extends HistoryMigrationAbstractTest {
  ...
  public void shouldConvertAllEntityDatesCorrectly() {
    ...
    List<FlowNodeInstanceEntity> userTaskFlowNodes = searchHistoricFlowNodes(processInstanceKey)
        .stream()
