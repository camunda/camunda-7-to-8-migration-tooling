# Investigation prompt — Row #10: `IncidentEntity.flowNodeInstanceKey`
...
Then compare your findings against `NULLABILITY-status.md` row #10 and any
...
## Related rows — noticing, not investigating

Row #3 (`JobEntity.elementInstanceKey`) lives in adjacent code. If your
investigation surfaces a shared root cause or shared fix, flag it for the
user. Do not investigate row #3 in this run.
