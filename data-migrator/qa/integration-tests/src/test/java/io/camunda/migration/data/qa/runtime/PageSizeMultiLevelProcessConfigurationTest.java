...
class PageSizeMultiLevelProcessConfigurationTest extends RuntimeMigrationAbstractTest {
  ...
  public void shouldPaginateMultiLevelProcessModel(CapturedOutput output) {
    ...
    Matcher matcher = Pattern.compile(PageSizeConfigurationTest.MIGRATOR_JOBS_FOUND + "1").matcher(output.getOut());
