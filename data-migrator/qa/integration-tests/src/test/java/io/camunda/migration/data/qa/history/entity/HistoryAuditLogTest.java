...
public class HistoryAuditLogTest extends AbstractMigratorTest {
  ...
  public void shouldMigrateAuditLogs() {
    ...
    // then
    List<ProcessInstanceEntity> c8ProcessInstance = historyMigration.searchHistoricProcessInstances("simpleProcess");
