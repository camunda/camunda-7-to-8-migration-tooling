...
@TestPropertySource(properties = {
    "camunda.migrator.interceptors[0].class-name=io.camunda.migration.data.qa.history.entity.variables.interceptor.pojo.FailingDecisionInterceptor"
})
public class HistoryDecisionInstanceInterceptorTest extends AbstractMigratorTest {
  ...
  public void shouldSkipOnlyFailingDecisionInstancesWhileSucceedingOthers() {
    ...
    logs.assertContains(formatMessage(SKIPPING_INTERCEPTOR_ERROR,
        failingDecisionInstanceId, "Test exception: Unsupported input value FAIL"));

    // Verify the successful one was NOT logged as skipped
    logs.assertDoesNotContain(formatMessage(SKIPPING_INTERCEPTOR_ERROR,
