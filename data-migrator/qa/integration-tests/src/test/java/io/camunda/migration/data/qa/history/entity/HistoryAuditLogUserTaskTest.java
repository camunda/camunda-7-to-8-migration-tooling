...
public class HistoryAuditLogUserTaskTest extends AbstractMigratorTest {
  ...
  public void shouldMigrateAuditLogsForTask() {
    ...
    // then
    List<ProcessInstanceEntity> c8ProcessInstance = historyMigration.searchHistoricProcessInstances("userTaskProcessId");
    assertThat(c8ProcessInstance).hasSize(1);
    List<UserTaskEntity> userTaskEntities = historyMigration.searchHistoricUserTasks(c8ProcessInstance.getFirst().processInstanceKey());
