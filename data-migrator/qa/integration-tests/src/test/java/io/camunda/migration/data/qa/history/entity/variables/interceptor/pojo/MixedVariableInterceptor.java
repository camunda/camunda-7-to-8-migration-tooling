 ...
 */
package io.camunda.migration.data.qa.history.entity.variables.interceptor.pojo;
 ...
 */
public class MixedVariableInterceptor implements VariableInterceptor {
  ...
  public void execute(VariableContext context) {
    context.setC8Value("MIXED_" + context.getC7Value());
  }
}
