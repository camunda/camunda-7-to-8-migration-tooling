...
@TestPropertySource(properties = {
    "camunda.migrator.interceptors[0].class-name=io.camunda.migration.data.qa.history.entity.variables.interceptor.pojo.FailingHistoricVariableInterceptor"
})
public class HistoryVariableInterceptorTest extends AbstractMigratorTest {
