...
public abstract class HistoryAbstractElementMigrationTest extends AbstractMigratorTest {
  ...
  public void migrateSimpleElementScenarios_expectTerminatedElement(final String processFile,
    ...
    // then
    List<ProcessInstanceEntity> processInstances = historyMigration.searchHistoricProcessInstances(processId);
