...
@TestPropertySource(properties = {
    "camunda.migrator.interceptors[0].class-name=io.camunda.migration.data.qa.history.entity.variables.interceptor.pojo.HistoricVariableOnlyInterceptor"
})
public class HistoryEntityTypeFilteringTest extends AbstractMigratorTest {
