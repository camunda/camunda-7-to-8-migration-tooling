...
public class HistoryFormMigrationTest extends AbstractMigratorTest {
  ...
  public void shouldMigrateFormWithUserTask() {
    ...
    var processInstances = historyMigration.searchHistoricProcessInstances("processWithFormId");
    ...
    for (var processInstance : processInstances) {
      var userTasks = historyMigration.searchHistoricUserTasks(processInstance.processInstanceKey());
  ...
  public void shouldMigrateFormOnStartEvent() {
    ...
    var processInstances = historyMigration.searchHistoricProcessInstances("processWithStartForm");
  ...
  public void shouldMigrateUserTaskForms() {
    ...
    var userTasks = historyMigration.searchHistoricUserTasks(processInstances.getFirst().processInstanceKey());
    assertThat(userTasks).hasSize(1);
    assertThat(userTasks.getFirst().formKey()).isEqualTo(expectedFormKey);
  }
  ...
  public void shouldMigrateMultipleUserTaskFormsInSameProcess() {
    ...
    // and - process instances should be migrated
    var processInstances = historyMigration.searchHistoricProcessInstances("processWithMultipleForms");
    assertThat(processInstances).hasSize(2);
  ...
  public void shouldMigrateFormsWithUserTasksAcrossTenants() {
    ...
    var allProcessInstances = historyMigration.searchHistoricProcessInstances("processWithFormId");
  ...
  public void shouldMigrateFormWithVersionBinding() {
    ...
    // and - process instance should be migrated
    var processInstances = historyMigration.searchHistoricProcessInstances("processWithFormVersionBinding");
    assertThat(processInstances).hasSize(1);
  ...
  public void shouldMigrateFormWithDeploymentBinding() {
    ...
    // and - process instance should be migrated
    var processInstances = historyMigration.searchHistoricProcessInstances("processWithFormDeploymentBinding");
    assertThat(processInstances).hasSize(1);
  ...
  public void shouldMigrateMultipleProcessesWithDifferentFormVersionBindings() {
    ...
    var latestBindingInstances = historyMigration.searchHistoricProcessInstances("processWithFormId");
    var versionBindingInstances = historyMigration.searchHistoricProcessInstances("processWithFormVersionBinding");
    ...
    var latestBindingUserTasks = historyMigration.searchHistoricUserTasks(latestBindingInstances.getFirst().processInstanceKey());
    ...
    var versionBindingUserTasks = historyMigration.searchHistoricUserTasks(versionBindingInstances.getFirst().processInstanceKey());
  ...
  public void shouldMigrateFormsWithLatestBinding() {
    ...
    var userTaskFirst = historyMigration.searchHistoricUserTasks(processInstanceFirst.processInstanceKey()).getFirst();
    ...
    var userTaskSecond = historyMigration.searchHistoricUserTasks(processInstanceSecond.processInstanceKey()).getFirst();
  ...
  public void shouldMigrateFormWithVersionBindingAcrossTenants() {
    ...
    // and - process instance should be migrated
    assertThat(historyMigration.searchHistoricProcessInstances("processWithFormVersionBinding")).hasSize(1);
  }
  ...
  public void shouldMigrateFormWithDeploymentBindingAcrossTenants() {
    ...
    var userTaskTenant1 = historyMigration.searchHistoricUserTasks(processInstanceTenant1.processInstanceKey()).getFirst();
    ...
    var userTaskTenant2 = historyMigration.searchHistoricUserTasks(processInstanceTenant2.processInstanceKey()).getFirst();
  ...
  public void shouldMigrateMixedBindingsAcrossMultipleTenants() {
    ...
    var latestBindingTenant1 = historyMigration.searchHistoricProcessInstances("processWithFormId").stream()
        .filter(pi -> tenant1.equals(pi.tenantId()))
        .toList();
    var versionBindingTenant1 = historyMigration.searchHistoricProcessInstances("processWithFormVersionBinding");
    var deploymentBindingTenant1 = historyMigration.searchHistoricProcessInstances("processWithFormDeploymentBinding");
    var latestBindingTenant2 = historyMigration.searchHistoricProcessInstances("processWithFormId").stream()
    ...
    var userTasksLatestT1 = historyMigration.searchHistoricUserTasks(latestBindingTenant1.getFirst().processInstanceKey());
    ...
    var userTasksVersionT1 = historyMigration.searchHistoricUserTasks(versionBindingTenant1.getFirst().processInstanceKey());
    ...
    var userTasksDeploymentT1 = historyMigration.searchHistoricUserTasks(deploymentBindingTenant1.getFirst().processInstanceKey());
    ...
    var userTasksLatestT2 = historyMigration.searchHistoricUserTasks(latestBindingTenant2.getFirst().processInstanceKey());
  ...
  public void shouldMigrateFormWithLatestBindingWhenNewVersionDeployed() {
    ...
    var userTaskFirstProcess = historyMigration.searchHistoricUserTasks(processInstances.getFirst().processInstanceKey()).getFirst();
    assertThat(userTaskFirstProcess.formKey()).isEqualTo(formV2.formKey());

    var userTaskLastProcess = historyMigration.searchHistoricUserTasks(processInstances.getLast().processInstanceKey()).getFirst();
  ...
  public void shouldMigrateMultipleFormVersionsWithMixedBindings() {
    ...
    var latestBindingInstances = historyMigration.searchHistoricProcessInstances("processWithFormId");
    var versionBindingInstances = historyMigration.searchHistoricProcessInstances("processWithFormVersionBinding");
    var deploymentBindingInstances = historyMigration.searchHistoricProcessInstances("processWithFormDeploymentBinding");
    assertThat(latestBindingInstances).hasSize(1);
    assertThat(versionBindingInstances).hasSize(1);
    ...
    var deploymentBindingUserTasks = historyMigration.searchHistoricUserTasks(deploymentBindingInstances.getFirst().processInstanceKey());
  ...
  public void shouldHandleFormReferenceExpression() {
    ...
    var processInstances = historyMigration.searchHistoricProcessInstances("processWithFormExpression");
    assertThat(processInstances).hasSize(1);
    ...
    assertThat(forms).hasSize(1);
    assertThat(forms.getFirst().formKey()).isNotNull();
    var processInstance = historyMigration.searchHistoricProcessInstances("processWithFormExpression").getFirst();
    var userTasks = historyMigration.searchHistoricUserTasks(processInstance.processInstanceKey());
    assertThat(userTasks).hasSize(1);
  ...
  public void shouldHandleEmbeddedFormKeyGracefully() {
    ...
    var processInstances = historyMigration.searchHistoricProcessInstances("processWithEmbeddedFormKey");
    assertThat(processInstances).hasSize(1);
  ...
  public void shouldHandleDeployedFormKeyGracefully() {
    ...
    // then - process instance should be migrated successfully despite unsupported form type
    var processInstances = historyMigration.searchHistoricProcessInstances("processWithDeployedFormKey");
    assertThat(processInstances).hasSize(1);
  ...
  public void shouldHandleGeneratedTaskFormKeyGracefully() {
    ...
    // then - process instance should be migrated successfully despite unsupported form type
    var processInstances = historyMigration.searchHistoricProcessInstances("processWithGeneratedTaskForm");
    assertThat(processInstances).hasSize(1);
  ...
  public void shouldHandleMissingFormReferenceGracefully() {
    ...
    var processInstances = historyMigration.searchHistoricProcessInstances("processWithMissingFormRef");
    assertThat(processInstances).hasSize(1);
  ...
  public void shouldMigrateMultipleProcessesWithMixedFormTypes() {
    ...
    var supportedFormInstances = historyMigration.searchHistoricProcessInstances("processWithFormId");
    var embeddedFormInstances = historyMigration.searchHistoricProcessInstances("processWithEmbeddedFormKey");
    var deployedFormInstances = historyMigration.searchHistoricProcessInstances("processWithDeployedFormKey");
    ...
    var supportedUserTasks = historyMigration.searchHistoricUserTasks(supportedFormInstances.getFirst().processInstanceKey());
    var embeddedUserTasks = historyMigration.searchHistoricUserTasks(embeddedFormInstances.getFirst().processInstanceKey());
    var deployedUserTasks = historyMigration.searchHistoricUserTasks(deployedFormInstances.getFirst().processInstanceKey());
  ...
  public void shouldHandleProcessWithBothSupportedAndUnsupportedForms() {
    ...
    var supportedInstances = historyMigration.searchHistoricProcessInstances("processWithFormId");
    var unsupportedInstances = historyMigration.searchHistoricProcessInstances("processWithEmbeddedFormKey");
    ...
    var supportedUserTasks = historyMigration.searchHistoricUserTasks(supportedInstances.getFirst().processInstanceKey());
    var unsupportedUserTasks = historyMigration.searchHistoricUserTasks(unsupportedInstances.getFirst().processInstanceKey());
  ...
  public void shouldHandleFormMigrationBetweenDeployments() {
    ...
    assertThat(processInstances).hasSize(2);
    assertThat(historyMigration.searchHistoricUserTasks(processInstances.getFirst().processInstanceKey()).getFirst().formKey())
        .isEqualTo(formAfterFirstMigration.formKey());
    assertThat(historyMigration.searchHistoricUserTasks(processInstances.getLast().processInstanceKey()).getFirst().formKey())
