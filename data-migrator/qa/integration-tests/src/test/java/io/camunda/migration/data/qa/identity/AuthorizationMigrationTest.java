...
public class AuthorizationMigrationTest extends IdentityAbstractTest {
  ...
  public void shouldMigrateApplicationAuthorizationsWithCorrectResourceId() {
    ...
    assertAuthorizationsContains(authorizations, ResourceType.COMPONENT, "tasklist", USER, USERNAME, getAllSupportedPerms(ResourceType.COMPONENT));
    assertAuthorizationsContains(authorizations, ResourceType.COMPONENT, "admin", USER, USERNAME, getAllSupportedPerms(ResourceType.COMPONENT));
    assertAuthorizationsContains(authorizations, ResourceType.COMPONENT, "*", USER, USERNAME, getAllSupportedPerms(ResourceType.COMPONENT));
    testHelper.verifySkippedViaLogs(invalidAuth.getId(), format(FAILURE_UNSUPPORTED_RESOURCE_ID, "invalid", Resources.APPLICATION.resourceName()), logs);
  }
