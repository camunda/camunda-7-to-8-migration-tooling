...
import static io.camunda.migrator.impl.logging.HistoryMigratorLogs.MIGRATING_INSTANCES;
...
public class HistoryMigrationRetryTest extends HistoryMigrationAbstractTest {
  ...
  @RegisterExtension
  protected LogCapturer logs = LogCapturer.create().captureForType(io.camunda.migrator.HistoryMigrator.class, Level.DEBUG);
