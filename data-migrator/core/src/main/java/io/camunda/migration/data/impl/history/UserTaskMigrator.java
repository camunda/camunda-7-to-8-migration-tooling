    ...
    if (shouldMigrate(c7UserTaskId, HISTORY_USER_TASK)) {
      ...
      if (isMigrated(c7UserTask.getProcessInstanceId(), HISTORY_PROCESS_INSTANCE)) {
        ...
        if (processInstance != null) {
          ...
          var historyCleanupDate = calculateHistoryCleanupDateForChild(processInstance.endDate(), c7UserTask.getRemovalTime());
      ...
      UserTaskDbModel dbModel;
      try {
        dbModel = convert(c7UserTask, builder);
