...
public class DecisionRequirementsDefinitionTransformer implements EntityInterceptor {
  ...
  public void execute(EntityConversionContext<?, ?> context) {
    ...
    String dmnXml = prefixDecisionIdsInDmn(Dmn.readModelFromStream(c7Client.getResourceAsStream(deploymentId, resourceName)));
   ...
   * This ensures that decision IDs in the migrated DMN are properly prefixed.
   *
   * @param dmnModelInstance the DMN model instance to modify
   * @return the modified DMN XML as a string
   */
  protected String prefixDecisionIdsInDmn(DmnModelInstance dmnModelInstance) {
