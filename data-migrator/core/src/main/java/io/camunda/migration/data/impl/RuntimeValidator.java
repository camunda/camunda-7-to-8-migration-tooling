...
import static io.camunda.migration.data.impl.util.C7Utils.MULTI_INSTANCE_BODY_SUFFIX;
import static io.camunda.migration.data.impl.util.C7Utils.PARALLEL_GATEWAY_ACTIVITY_TYPE;
import static io.camunda.migration.data.impl.util.C7Utils.getActiveActivityIdsById;
import static io.camunda.migration.data.impl.util.ExceptionUtils.callApi;
import static io.camunda.migration.data.impl.logging.RuntimeValidatorLogs.FAILED_TO_PARSE_BPMN_MODEL;
...
import io.camunda.migration.data.impl.logging.RuntimeValidatorLogs;
