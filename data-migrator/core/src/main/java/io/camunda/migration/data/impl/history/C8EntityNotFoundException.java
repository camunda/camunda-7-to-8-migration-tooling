...
public class C8EntityNotFoundException extends RuntimeException {
  ...
  public C8EntityNotFoundException(IdKeyMapper.TYPE entityType, Long c8Key, String flowNodeId) {
    super(String.format(SKIP_REASON_DELETED_IN_C8_ASSOCIATED, entityType.getDisplayName(), c8Key, flowNodeId));
  }
}
