...
public class HistoryMigratorLogs {
  ...
  public static final String SKIP_REASON_MISSING_PARENT = "Missing parent node";
  ...
  public static final String SKIPPING_FLOW_NODE_MISSING_PARENT = "Migration of historic flow nodes with C7 ID [{}] skipped. Missing parent node";
