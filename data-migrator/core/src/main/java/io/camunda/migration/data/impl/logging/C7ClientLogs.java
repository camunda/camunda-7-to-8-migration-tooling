...
public class C7ClientLogs {
  ...
  public static final String FAILED_TO_FETCH_DMN_XML = "Failed to fetch DMN model instance for decision definition "
      + "Id: ";
  ...
  public static final String FAILED_TO_FETCH_FORM_FOR_PD_AND_TDK = FAILED_TO_FETCH_FORM + FAILED_TO_FETCH_FORM_FOR_PD + " and taskDefinitionKey [%s]";
}
