...
import static io.camunda.migration.model.converter.cli.ConvertCommand.*;

import io.camunda.migration.model.converter.DiagramType;
import java.io.File;
...
@Command(
    ...
    description = {
      ...
      "%nExecute as:",
      "%njava -Dfile.encoding=UTF-8 -jar camunda-7-to-8-diagram-converter-cli.jar local%n"
    },
