...
public class HistoryMigrationSkippingTest extends HistoryMigrationAbstractTest {
  ...
  // Note: Test for ID collision scenario (shouldNotSkipTaskVariablesWhenEntityWithSameIdButDifferentTypeIsSkipped)
  // was removed as it required artificial white-box manipulation via dbClient.insert().
  // ID collision handling is an internal implementation detail that doesn't need explicit testing
  // in behavior tests. If needed, this should be tested at the persistence layer.
}
