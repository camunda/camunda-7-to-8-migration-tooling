...
export const external_task = [
		...
		discontinued: {
			rowInfo: [
				...
				},
				{
					...
					rightEntry: (
						<p>
							No businessKey in Camunda 8.8. <a href="https://roadmap.camunda.com/c/296-business-key">Planned for a future release</a>, but unlikely to be required in this context.
						</p>
					),
				},
				{
					...
					rightEntry: (
						<p>
							In Camunda 8.8, it is not possible to restrict the
	...
	},
	{
		...
		mappedExplanation: (
			<div>
				In Camunda 8.8, the <code>POST Search jobs</code> endpoint can
