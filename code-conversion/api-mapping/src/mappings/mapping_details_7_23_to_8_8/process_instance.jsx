...
export const process_instance = [
		...
		discontinued: {
			rowInfo: [
				...
				},
				{
					...
					rightEntry: (
						<p>
							Not yet possible in Camunda 8.8. It's not possible
		...
		discontinued: {
			rowInfo: [
				...
				},
				{
					...
					rightEntry: (
						<p>
							Not yet possible in Camunda 8.8. Subprocesses are
							also canceled.
						</p>
					),
				},
	...
	},
	{
		...
		roadmapExplanation: (
			<p>
				Not yet possible in Camunda 8.8. Adding comments to user tasks
