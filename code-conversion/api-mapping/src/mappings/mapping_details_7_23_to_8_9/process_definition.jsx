...
export const process_definition = [
				...
				},
				{
					...
					rightEntry: (
						<p>
							...
							with specific incident information in Camunda 8.9.
	...
	},
	{
		...
		target: {},
		discontinuedExplanation: "Not available in Camunda 8.9.",
	},
	{
		origin: {
		...
		discontinued: {
			rowInfo: [
				...
				},
				{
					...
					rightEntry: (
						<p>
							Not yet possible in Camunda 8.9. This functionality
	...
	},
	{
		...
		mappedExplanation:
			"See Delete By Key endpoint. Deletion of resource is not tenant-specific in Camunda 8.9.",
	},
	{
		origin: {
			path: "/process-definition/key/{key}/tenant-id/{tenant-id}",
		...
		discontinued: {
			rowInfo: [
				...
				},
				{
					...
					rightEntry: (
						<p>
							This endpoint is not tenant-specific in Camunda 8.9.
	...
	},
	{
		...
		target: {},
		discontinuedExplanation:
			"There is no endpoint yet to group process instance statistics by process definition in Camunda 8.9. Statistics can be grouped by elements, see Get Activity Instance Statistics.",
	},
	{
		origin: {
	...
	},
	{
		...
		target: {},
		discontinuedExplanation:
			"Not yet possible in Camunda 8.9. A running process instance can be modified. A canceled process instance cannot be modified.",
	},
	{
		origin: {
	...
	},
	{
		...
		target: {},
		discontinuedExplanation: "Not possible in Camunda 8.9.",
	},
	{
		origin: {
