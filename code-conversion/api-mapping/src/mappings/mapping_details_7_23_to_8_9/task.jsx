...
export const task = [
			...
			rowInfo: [
				...
				},
				{
					...
					rightEntry: (
						<>
							<p>
								Not yet possible in Camunda 8.9. In Camunda 7,
				...
				},
				{
					...
					rightEntry: (
						<p>Not applicable for the filter in Camunda 8.9.</p>
					),
				},
				{
					leftEntry: (
				...
				},
				{
					...
					rightEntry: (
						<p>
							Not yet possible in Camunda 8.9.
				...
				},
				{
					...
					rightEntry: (
						<p>Not yet possible in Camunda 8.9. No sub tasks.</p>
					),
				},
				{
					...
					rightEntry: (
						<p>
							Not yet possible in Camunda 8.9. No comments for
							tasks yet.
						</p>
					),
				},
	...
	},
	{
		...
		discontinuedExplanation:
			"Manual creation of tasks is not yet available in Camunda 8.9.",
	},
	{
		origin: {
	...
	},
	{
		...
		target: {},
		discontinuedExplanation:
			"Manual deletion of tasks is not yet available in Camunda 8.9.",
	},
	{
		origin: {
			path: "/task/{id}",
	...
	},
	{
		...
		target: {},
		discontinuedExplanation:
			"It is not possible to throw a BPMN error from a Camunda user task in Camunda 8.9.",
	},
	{
		origin: {
		...
		target: {},
		discontinuedExplanation:
			"It is not possible to throw a BPMN escalation from a Camunda user task in Camunda 8.9.",
	},
	{
		origin: {
			path: "/task/{id}/claim",
	...
	},
	{
		...
		target: {},
		discontinuedExplanation:
			"It is not yet possible to delegate a task to a different assignee in Camunda 8.9.",
	},
	{
		origin: {
	...
	},
	{
		...
		target: {},
		discontinuedExplanation:
			"It is not yet possible to delegate a task to a different assignee in Camunda 8.9, so there is also no need to resolve it.",
	},
	{
		origin: {
