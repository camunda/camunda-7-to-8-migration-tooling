...
export const external_task = [
	{
		...
		mappedExplanation: (
			<div>
				In Camunda 8.9, the <code>POST Search jobs</code> endpoint can
			...
			rowInfo: [
				{
					...
					rightEntry: <p>No job priority in Camunda 8.9.</p>,
				},
				{
					leftEntry: <pre>(string) topics[].businessKey</pre>,
					rightEntry: (
						<p>
							No businessKey in Camunda 8.9. <a href="https://roadmap.camunda.com/c/296-business-key">Planned for a future release</a>, but unlikely to be required in this context.
						</p>
					),
				},
				{
	...
	},
	{
		...
		direct: {
			...
			additionalInfo: (
				<>
					<p>
						In Camunda 8.9, this endpoint cannot be used to raise an
	...
	},
	{
		...
		discontinuedExplanation: (
			<div>
				There is no endpoint in Camunda 8.9 yet to search for jobs
				types.
			</div>
		),
	},
			...
			rowInfo: [
				{
					...
					rightEntry: (
						<p>
							For this endpoint in Camunda 8.9, local variables
	...
	},
	{
		...
		discontinuedExplanation: (
			<div>
				There is no endpoint in Camunda 8.9 yet to retrieve the error
			...
			rowInfo: [
				{
					...
					rightEntry: (
						<p>
							In Camunda 8.9, there is not additional field for
							error details.
						</p>
					),
				},
	...
	},
	{
		...
		target: {},
		discontinuedExplanation: (
			<p>There is no job priority yet in Camunda 8.9.</p>
		),
	},
	{
		origin: {
