...
export const task_attachment = [
	{
		...
		mappedExplanation: (
			<>
				<div>
					In Camunda 8.9, documents can be uploaded and downloaded via
				...
				<div>
					...
					<a
						href="https://docs.camunda.io/docs/8.9/guides/document-handling/"
						target="_blank"
					>
						the docs
					</a>
			...
			rowInfo: [
				{
					...
					rightEntry: (
						<p>
							In Camunda 8.9, documents are not directly relatable
