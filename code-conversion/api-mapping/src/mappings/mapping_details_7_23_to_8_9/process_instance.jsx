...
export const process_instance = [
		...
		discontinued: {
			rowInfo: [
				...
				},
				{
					...
					rightEntry: (
						<p>
							No businessKey in Camunda 8.9. <a href="https://roadmap.camunda.com/c/296-business-key">Planned for a future release</a>.
						</p>
					),
				},
				{
				...
				},
				{
					...
					rightEntry: <p>No CMMN in Camunda 8.9.</p>,
				},
				{
					leftEntry: (
						<pre>
				...
				},
				{
					...
					rightEntry: (
						<p>
							...
							have no active subprocess instance in Camunda 8.9.
						</p>
					),
				},
			],
		...
		discontinued: {
			rowInfo: [
				...
				},
				{
					...
					rightEntry: (
						<p>
							Not yet possible in Camunda 8.9. It's not possible
			...
			rowInfo: [
				{
					...
					rightEntry: (
						<p>
							...
							not exist in Camunda 8.9.
						</p>
					),
				},
				{
					leftEntry: <pre>(boolean) withRootIncidents</pre>,
					rightEntry: <p>Not possible in Camunda 8.9.</p>,
				},
				{
					leftEntry: (
						<pre>
				...
				},
				{
					...
					rightEntry: (
						<p>These filters are not available in Camunda 8.9.</p>
					),
				},
				{
					leftEntry: <pre>(string) startedBy</pre>,
					rightEntry: <p>This is not possible in Camunda 8.9.</p>,
				},
				{
					leftEntry: (
						<pre>
	...
	},
	{
		...
		discontinuedExplanation: (
			<p>
				There is no batch endpoint yet to update retries for multiple
				jobs at once. You can update each job with the Update job
				endpoint.
			</p>
		),
	},
	...
	},
	{
		...
		target: {},
		roadmapExplanation:
			"Not yet possible in Camunda 8.9. Activating/suspending process instances is on the roadmap.",
	},
	{
		origin: {
			...
			rowInfo: [
				{
					...
					rightEntry: (
						<>
							...
							<p>
								In Camunda 8.9, variables can be updated for one
		...
		discontinued: {
			rowInfo: [
				...
				},
				{
					...
					rightEntry: (
						<p>
							Not yet possible in Camunda 8.9. Subprocesses are
							also canceled.
						</p>
					),
				},
	...
	},
	{
		...
		mappedExplanation: (
			<p>
				Not yet possible in Camunda 8.9. You can retrieve all active
	...
	},
	{
		...
		roadmapExplanation: (
			<p>
				Not yet possible in Camunda 8.9. Adding comments to user tasks
			...
			rowInfo: [
				{
					...
					rightEntry: (
						<p>
							In Camunda 8.9, the element is targeted via the{" "}
							<code>elementId</code>.
						</p>
					),
				},
				...
				},
				{
					...
					rightEntry: (
						<p>
							Not yet possible in Camunda 8.9. A integer{" "}
			...
			rowInfo: [
				{
					...
					rightEntry: (
						<p>
							...
							8.9. But you can set them to <code>null</code> or an
							empty string.
						</p>
					),
				},
	...
	},
	{
		...
		mappedExplanation: (
			<p>
				In Camunda 8.9, there is no endpoint to delete a process
			...
			rowInfo: [
				{
					...
					rightEntry: (
						<p>
							In Camunda 8.9, a document is uploaded to a store in
