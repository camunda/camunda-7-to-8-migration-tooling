...
-   Hosts a **[Camunda 7 API to Camunda 8 API Mapping WebApp (WIP)](https://camunda.github.io/camunda-7-to-8-migration-tooling/)** to quickly find language-agnostic information about Camunda 7 API endpoints and how they relate to Camunda 8 endpoints. Specifically:
