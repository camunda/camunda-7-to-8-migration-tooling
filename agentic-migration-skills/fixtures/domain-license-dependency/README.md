...
`expected-blocked/MIGRATION_REPORT.md`. The report must list both call sites as blockers. The skill
must not replace either path with an exception or fabricated license material.
