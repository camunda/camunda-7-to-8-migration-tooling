...
This checklist defines every code transformation item. See `../SKILL.md` for the delegate gate and
OpenRewrite order. Approach A uses this checklist to clean the recipe output. In Approach B, the
skill applies the full checklist by hand.
