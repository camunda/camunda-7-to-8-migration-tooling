...
| `c7-camunda-form-reference` | `camunda:formRef` | no finding for literal values; expression values may emit an expression-transformation finding | Convert the `.form`, confirm the id matches, and record the binding decision |
