...
| Any source with a complete process-instance query count | Fetch `20-client-code/10-process-engine/count-query-results.md` regardless of the primary inventory type |
...
| Test code | Fetch the files for the detected assertions: `40-test-assertions/10-assertions/10-complete-test-case.md`, `40-test-assertions/10-assertions/20-process-instance.md`, `40-test-assertions/10-assertions/30-process-variable.md`, `40-test-assertions/10-assertions/40-user-task.md`, `40-test-assertions/10-assertions/50-message.md`, `40-test-assertions/10-assertions/60-job.md`, and `40-test-assertions/10-assertions/70-executable-entry-points.md` when standalone executable coverage is required |
