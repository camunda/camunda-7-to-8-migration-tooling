...
Do not reconstruct it from the original Camunda 7 model. Do not run this gate for analyze-only runs
that create no converted copies. Apply it when a converted copy participates in the verification or
when the run resolves a category verdict.
