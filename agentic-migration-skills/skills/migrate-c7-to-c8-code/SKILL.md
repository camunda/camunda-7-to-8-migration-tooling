...
If the source listener uses a nested `camunda:script`, keep the finding **needs review** even after relocation planning because the converter also emits a separate script finding for the script body.
