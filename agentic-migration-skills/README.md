...
review. It applies linkage and deployment only after the verification gate. It deploys only after an
explicit request and selected target. It records no-target deployment as out of scope and keeps
